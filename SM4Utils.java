...
public class SM4Utils {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("SM4 密文: " + cipherText);
        System.out.println("");

        plainText = sm4.decryptData_ECB(cipherText);
        System.out.println("SM4 明文: " + plainText);
        System.out.println("");

        System.out.println("SM4 CBC模式");
