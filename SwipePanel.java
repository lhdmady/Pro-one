...
import com.heimavista.fiedorasport.R;
...
public class SwipePanel extends FrameLayout {
    ...
    public SwipePanel(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            setLeftDrawable(ta.getDrawable(R.styleable.SwipePanel_spLeftDrawable));
            setTopDrawable(ta.getDrawable(R.styleable.SwipePanel_spTopDrawable));
            setRightDrawable(ta.getDrawable(R.styleable.SwipePanel_spRightDrawable));
            setBottomDrawable(ta.getDrawable(R.styleable.SwipePanel_spBottomDrawable));
